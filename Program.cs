...
//    {
//        policyBuilder
//            .WithOrigins("https://pizzaorderapi-buh3dvavakbbb7df.canadacentral-01.azurewebsites.net", "https://localhost:4200")
//            .AllowAnyHeader()
//            .AllowAnyMethod();
//    });
//});
...
// ? CORS configuration - allow only your Angular app and local dev
builder.Services.AddCors(options =>
{
    options.AddPolicy("AllowAngularClient", policyBuilder =>
    {
        policyBuilder
            .WithOrigins(
                "https://pizzaorderclient-b2ddeaduhfcvereu.canadacentral-01.azurewebsites.net",
                "http://localhost:4200",
...
app.UseCors("AllowAngularClient"); // ? Use correct CORS policy
